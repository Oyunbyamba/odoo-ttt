odoo.define("hrms_dashboard.Dashboard", function (require) {
  ...
  var HrDashboard = AbstractAction.extend({
    ...
    cssLibs: ["/hrms_dashboard/static/src/css/lib/nv.d3.css"],
    ...
    get_emp_image_url: function (employee) {
      return (
        ...
        "/web/image?model=hr.employee&field=image&id=" +
        employee
      );
    },
          ...
          function histoGram(fD) {
            ...
            function mouseover(d) {
              ...
              var st = fData.filter(function (s) {
                  return s.l_month == d[0];
                })[0],
                nD = d3.keys(st.leave).map(function (s) {
                  return { type: s, leave: st.leave[s] };
                });
